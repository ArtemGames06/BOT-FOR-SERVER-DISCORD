...
async def on_ready():
	...
	await bot.change_presence(status=discord.Status.do_not_disturb, activity=discord.Game("Тестинг")) # Изменяем статус боту
...
bot.run("OTQ4NDE0Njc2MzM5OTMzMTk0.Yh7d_w.PwRTk-n_P9FWGcQMbAhuHuLYXng")
